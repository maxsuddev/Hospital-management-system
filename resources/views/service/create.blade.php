                    ...
                    <form enctype="multipart/form-data" action="{{ route('service.store') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="@error('category_id') is-invalid @enderror form-control-lg form-control" id="category_id" name="category_id">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('price') }}" type="text" class="@error('price') is-invalid @enderror form-control-lg form-control" placeholder="Price" name="price">
                                @error('price')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
